...
nettemp = newff(inputdata',outputdata',hidlay);
...
mapeN = maeN*100;
legend(['Neural',[' MSE =', num2str(mseN)],[' MAPE =', num2str(mapeN)]],['Data Experiment'],'location','southwest')
...
mapeNH = maeNH*100;
legend(['Neural Hammers',[' MSE =', num2str(mseNH)],[' MAPE =', num2str(mapeNH)]],['Data Experiment'],'location','southwest')

%%
nettemp2 = newff(NH',outputdata',hidlay);
...
mapeNHW = maeNHW*100;
legend(['Neural HW',[' MSE =', num2str(mseNHW)],[' MAPE =', num2str(mapeNHW)]],['Data Experiment'],'location','southwest')
